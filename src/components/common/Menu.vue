...
export default {
  data() {
    ...
    methods: {
      ...
      list2(){
         this.axios.get("http://localhost:8088/menu/listMenu2").then((response) => {
      if (response.status == 200) {
        console.log(response)
        if(this.powerid==2){
        this.menu = response.data;
      ...
      list3(){
         this.axios.get("http://localhost:8088/menu/listMenu3").then((response) => {
      if (response.status == 200) {
        console.log(response)
        if(this.powerid==3){
        this.menu = response.data;
      ...
      list4(){
         this.axios.get("http://localhost:8088/menu/listMenu4").then((response) => {
      if (response.status == 200) {
        console.log(response)
        if(this.powerid==4){
        this.menu = response.data;
   ...
   created() {
    ...
    this.axios.get("http://localhost:8088/user/tokenPowerId",{
      params:{
              token
