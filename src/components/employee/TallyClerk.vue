<template>
    ...
    <div>
    dd 姓名：<el-input v-model="username" placeholder="请输入内容" style=" width: 150px;"></el-input>
     ...
     电话:<el-input v-model="phone" placeholder="请输入内容" style=" width: 150px;"></el-input>
       ...
       <el-button type="primary" style="margin-left: 20px;" @click="querynove">查询</el-button>
        <el-button type="primary" style="margin-left: 20px;" @click="addnove">添加啊啊</el-button>
    ...
    data(){
        ...
        addnove(){
          this.$router.push("/addTally")
            ...
            ,
        list(){
              this.axios.get("http://localhost:8088/user/Listtally",{
